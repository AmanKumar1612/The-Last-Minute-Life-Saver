...
export default function Sidebar({ collapsed, onToggleCollapse }) {
  ...
  return (
    <aside className={`fixed left-0 top-0 h-screen glass flex flex-col transition-all duration-300 z-50 ${sidebarWidth}`}>
      {/* Logo */}
      ...
      <div className="px-3 py-3 border-t border-white/5 space-y-1 flex-shrink-0">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-white/5 transition-all w-full"
        >
